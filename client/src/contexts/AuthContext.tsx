...
export const AuthProvider = ({ children }: AuthProviderProps) => {
  ...
  const connectSpotify = () => {
    window.location.href = `${import.meta.env.VITE_API_BASE_URL || 'http://localhost:8888/api/v1'}/auth/spotify/login`;
  };

  const connectGoogle = () => {
    window.location.href = `${import.meta.env.VITE_API_BASE_URL || 'http://localhost:8888/api/v1'}/auth/google/login`;
  };
